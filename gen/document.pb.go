...
func (*Keyword) Descriptor() ([]byte, []int) {
	return fileDescriptor_2a2c4e9d80a6422b, []int{0}
}
...
func (*Document) Descriptor() ([]byte, []int) {
	return fileDescriptor_2a2c4e9d80a6422b, []int{1}
}
...
func (m *Document) GetDocId() uint64 {
	if m != nil {
		return m.DocId
	}
	return 0
...
func init() {
	proto.RegisterType((*Keyword)(nil), "pb.Keyword")
	proto.RegisterType((*Document)(nil), "pb.Document")
}

func init() { proto.RegisterFile("api/document.proto", fileDescriptor_2a2c4e9d80a6422b) }

var fileDescriptor_2a2c4e9d80a6422b = []byte{
	// 223 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Keyword) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Word) > 0 {
		i -= len(m.Word)
		copy(dAtA[i:], m.Word)
		i = encodeVarintDocument(dAtA, i, uint64(len(m.Word)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Field) > 0 {
		i -= len(m.Field)
		copy(dAtA[i:], m.Field)
		i = encodeVarintDocument(dAtA, i, uint64(len(m.Field)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Document) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Bytes) > 0 {
		i -= len(m.Bytes)
		copy(dAtA[i:], m.Bytes)
		i = encodeVarintDocument(dAtA, i, uint64(len(m.Bytes)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Keywords) > 0 {
	...
	if m.BitsFeature != 0 {
		i = encodeVarintDocument(dAtA, i, uint64(m.BitsFeature))
		i--
		dAtA[i] = 0x18
	}
	if m.DocId != 0 {
		i = encodeVarintDocument(dAtA, i, uint64(m.DocId))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Id) > 0 {
...
func (m *Document) Size() (n int) {
	...
	if m.DocId != 0 {
		n += 1 + sovDocument(uint64(m.DocId))
	}
	if m.BitsFeature != 0 {
		n += 1 + sovDocument(uint64(m.BitsFeature))
	}
	if len(m.Keywords) > 0 {
